		...
		<div id="scroller"></div>
			...
			<header class="header" role="banner">
				...
				<div id="inner-header" class="wrap clearfix">
					...
					<div id="logo"><a href="<?php echo home_url(); ?>" rel="nofollow"><!-- <?php bloginfo('name'); ?> --><img src="<?php echo get_template_directory_uri(); ?>/library/images/logobirdblue4@2x.png" width="383px" height="56px"></a></div>
