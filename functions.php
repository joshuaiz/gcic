...
function add_home_admin_menu_item() {
  // $page_title, $menu_title, $capability, $menu_slug, $callback_function
  add_menu_page(__('Home Page'), __('Home Page'), 'read', 'post.php?post=16&action=edit','','dashicons-admin-home', 6 );
}
add_action('admin_menu', 'add_home_admin_menu_item');
